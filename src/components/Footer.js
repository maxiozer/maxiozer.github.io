    ...
    render() {
        return (
            <div id="footer">
                <div className="inner">
                    <ul className="icons">
                        <li><a onClick={this.registerEvent.bind(this, "Linkedin")} href="https://www.linkedin.com/in/maximilianoozernickz" target="__blank"  rel="noopener noreferrer" className="icon fa-linkedin"><span className="label">Twitter</span></a></li>
